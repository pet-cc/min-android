 ...
 * {@link ConversasFragment.OnFragmentInteractionListener} interface
...
public class ConversasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<Conversa> listaConversas = new ArrayList<>();
        listaConversas.add(new Conversa("Daniel Seitenfus","Oi. tudo bem?", "16:45", 5));
        listaConversas.add(new Conversa("Igor Prado","Oiiiii", "22:15", 5));
